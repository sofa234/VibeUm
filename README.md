...
<head>
  ...
  <title>Онлайн-школа ВайбУм - Раскрываем способности каждого ребёнка!</title>
  <meta name="description" content="Онлайн-школа ВайбУм - инновационный подход к обучению детей. Авторские методики, индивидуальный подход, увлекательные занятия.">
  ...
  <style>
    ...
    * {
    ...
    .nav-links a:hover, .contacts-btn:hover {
      color: var(--orange);
    ...
    @media (max-width: 768px) {
      ...
      /* Адаптация карточек целевых групп */
      .group-cards {
        grid-template-columns: 1fr;
      }
    ...
    <div class="footer-content">
      <div class="footer-about">
        <div class="footer-logo">
          <img src="logo.png" alt="Логотип ВайбУм" class="footer-logo-img">
          <div>
